####### This temporal RNN (single layer) LSTM network takes 28 pixel inputs on the NMIST dataset image, feeds each slice at a time until all 28 slices have been feed meanwhile the the 8 LSTM cells in the single deep layer are doing their thing. OPtimizer is Adam and cross entropy is used to measure error.
